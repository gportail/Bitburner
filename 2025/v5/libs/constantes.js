...
export const ScriptBuyProgram = 'v5/buy-programs.js';
// export const ScriptAutoHack = 'autohack.js';
export const ScriptDeploySingle = 'v5/deploy_single.js';
...
export const ScriptSingleW = 'v5/singleW.js';
export const ScriptSingleG = 'v5/singleG.js';
export const ScriptSingleH = 'v5/singleH.js';

export const ScriptShare = 'v5/shareRam.js';
export const ScriptRunShare = 'v5/run_share.js';


export const ScriptLoopSingleW = 'v5/loop_singleW.js';
export const ScriptLoopSingleG = 'v5/loop_singleG.js';
export const ScriptLoopSingleH = 'v5/loop_singleH.js';

export const ScriptBasic = 'v5/basic_hack.js';
...
export const Moniteur32Go = 'v5/moniteur_32Go.js';
